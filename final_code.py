...
def get_award_tweets(data, list1, spec = "people"):
    ...
    if spec == "people":
        synonyms = {
            ...
            'mini' : ['mini-series', 'mini', 'series', 'miniseries','limited']
        }
...
def extract_hosts(data,people_kb):
    # clean data
    cleaned_data = []
...
def main_exec(award_list,df,kb_p,kb_m,year):
    """
